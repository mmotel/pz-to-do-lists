    ...
    dbc.open(function (err){
      if(err){
        ...
        dbc.collection('appLists', function (err, coll){
          ...
          var listToInsert = new List(newList.id, newList.fbid, newList.name, newList.descr);
    ...
    dbc.open(function (err){
      if(err){
        ...
        dbc.collection('appTasks', function (err, coll){
          ...
          var taskToInsert = new Task(newTask.id, newTask.fbid, newTask.listid, newTask.name, newTask.descr, newTask.deadline);
