module.exports = function (Data){
	...
	var List = function(id, fbid, groupid, name, descr, trash){
		this.id = id;
		this.fbid = fbid;
	...
	var AddList = function(newList, callback){
		Data.insertData("appLists", 
			new List(genId(), newList.fbid, newList.groupid, newList.name, newList.descr), callback);
	};
	...
	var FindAllLists = function (fbid, callback){
		Data.findAllData("appLists", {"fbid": fbid, "groupid": null}, callback);
	};
