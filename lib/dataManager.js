module.exports = function (Data){
  ...
  var RemoveUser = function(id, callback){
    Data.removeData("appUsers", {"id": id}, {"trash": true}, callback);
  };
  ...
  var RemoveList = function(id, callback){
    Data.removeData("appLists", {"id": id}, {"trash": true}, callback);
  };
  ...
  var RemoveTask = function(id, callback){
    Data.removeData("appTasks", {"id": id}, {"trash": true}, callback);
  };
